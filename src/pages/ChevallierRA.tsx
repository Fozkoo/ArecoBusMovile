...
interface ChevallierRA {
    horarios: string[];
}

const ChevallierRA: React.FC = () => {
    const [chevallierData, setChevallierData] = useState<ChevallierRAData | null>(null);
        ...
        const fetchData = async () => {
            try {
                ...
                if (helperExport.diaHoy >= 1 && helperExport.diaHoy <= 7) {
                    data = await Helper.getHorariosByIdBusIdDia(12, 1);
                } 
                setData(data);
        ...
        const fetchData = async () => {
            try {
                const [data1] = await Promise.all([
                    Helper.busInfoById(12),
                    Helper.getHorariosByIdBusIdDia(12, 1),
                ]);
